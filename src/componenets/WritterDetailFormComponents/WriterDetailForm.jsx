...
import { removeAlert } from "../../features/writerRequest/writerRequestSlice";
import { setupUpdateWriter } from "../../features/writerRequest/writerRequestThunk";
...
const WriterDetailForm = () => {
  ...
  function update(e) {
    ...
    dispatch(setupUpdateWriter(data)).then((res) => {
      //to get latest inforamation of current user in push in store
      if (!res.error) {
  ...
  return (
    <div className="writerDetailFormWrapper" ref={alert}>
              ...
              <div className="d-flex">
                <div className="onlyMe-div">
                  <input
                    ...
                    id="onlyMeCity"
                    name="cityPrivacy"
                    checked={data.cityPrivacy == "private" && true}
                    value="private"
                    onChange={handleChange}
                  />
                ...
                <div className="showPublic-div">
                  ...
                  <input
                    ...
                    id="showCity"
                    name="cityPrivacy"
                    checked={data.cityPrivacy == "public" && true}
                    value="public"
                    onChange={handleChange}
                  />
              ...
              <div className="d-flex">
                <div className="onlyMe-div">
                  <input
                    ...
                    id="onlyMeEmail"
                    name="emailPrivacy"
                    checked={data.emailPrivacy == "private" && true}
                    value="private"
                    onChange={handleChange}
                  />
                ...
                <div className="showPublic-div">
                  ...
                  <input
                    ...
                    id="showEmail"
                    name="emailPrivacy"
                    checked={data.emailPrivacy == "public" && true}
                    value="public"
                    onChange={handleChange}
                  />
      ...
      /> */}
        ...
        <div className="TextFields " style={{ marginTop: "20px" }}>
          ...
          {shortBioAlert && (
            <AlertLength
              ...
              className="descAlert"
            >
              <span>You can write only upto 400 characters.</span>
              <span className="spanAlert-reached">Text limits reached</span>
            </AlertLength>
          )}
          <textarea
          ...
          <div className="TextFields">
            ...
            {descAlert && (
              <AlertLength
                ...
                className="descAlert"
              >
                <span>You can write only upto 1000 characters.</span>
                <span className="spanAlert-reached">Text limits reached</span>
              </AlertLength>
            )}
            <textarea
        ...
        >
          <button onClick={handleRequired} className="submit">
            Save
          </button>
